...
forktest(void)
{
  ...
  36:	3be50513          	addi	a0,a0,958 # 3f0 <jointhread+0x8>
  ...
  58:	3ec50513          	addi	a0,a0,1004 # 440 <jointhread+0x58>
  ...
  6e:	39650513          	addi	a0,a0,918 # 400 <jointhread+0x18>
  ...
  80:	39c50513          	addi	a0,a0,924 # 418 <jointhread+0x30>
  ...
  b0:	38450513          	addi	a0,a0,900 # 430 <jointhread+0x48>
