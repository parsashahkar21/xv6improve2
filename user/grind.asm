...
{
     c1c:	715d                	addi	sp,sp,-80
     c1e:	e486                	sd	ra,72(sp)
     c20:	e0a2                	sd	s0,64(sp)
     c22:	fc26                	sd	s1,56(sp)
     c24:	0880                	addi	s0,sp,80
     c26:	84aa                	mv	s1,a0
  char buf[20];
  int i, neg;
  uint x;
  ...
  if(neg)
    ...
    buf[i++] = '-';
     ...
     c76:	fef70423          	sb	a5,-24(a4)
     c7a:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     c7e:	02e05a63          	blez	a4,cb2 <printint+0x96>
     c82:	f84a                	sd	s2,48(sp)
     c84:	f44e                	sd	s3,40(sp)
     c86:	fb840793          	addi	a5,s0,-72
  ...
  while(--i >= 0)
     ...
     cae:	7942                	ld	s2,48(sp)
     cb0:	79a2                	ld	s3,40(sp)
}
     cb2:	60a6                	ld	ra,72(sp)
     cb4:	6406                	ld	s0,64(sp)
     cb6:	74e2                	ld	s1,56(sp)
     cb8:	6161                	addi	sp,sp,80
     cba:	8082                	ret
    x = -xx;
