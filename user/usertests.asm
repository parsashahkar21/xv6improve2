...
{
    4b4e:	715d                	addi	sp,sp,-80
    4b50:	e486                	sd	ra,72(sp)
    4b52:	e0a2                	sd	s0,64(sp)
    4b54:	fc26                	sd	s1,56(sp)
    4b56:	0880                	addi	s0,sp,80
    4b58:	84aa                	mv	s1,a0
  char buf[20];
  int i, neg;
  uint x;
  ...
  if(neg)
    ...
    4ba8:	fef70423          	sb	a5,-24(a4)
    4bac:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    4bb0:	02e05a63          	blez	a4,4be4 <printint+0x96>
    4bb4:	f84a                	sd	s2,48(sp)
    4bb6:	f44e                	sd	s3,40(sp)
    4bb8:	fb840793          	addi	a5,s0,-72
  ...
  while(--i >= 0)
    ...
    4be0:	7942                	ld	s2,48(sp)
    4be2:	79a2                	ld	s3,40(sp)
}
    4be4:	60a6                	ld	ra,72(sp)
    4be6:	6406                	ld	s0,64(sp)
    4be8:	74e2                	ld	s1,56(sp)
    4bea:	6161                	addi	sp,sp,80
    4bec:	8082                	ret
    x = -xx;
